...
const fakeProductArray = [
  {
    ...
    description: 'A powerful gaming laptop designed for immersive gaming experiences.',
    price: 1999.99,
    ratings: 4.25,
    images: [
      {
  ...
  },
  {
    ...
    description: 'The latest smartphone with a stunning display and powerful camera.',
    price: 999.99,
    ratings: 4.75,
    images: [
      {
  ...
  },
  {
    ...
    description: 'A reliable laptop for everyday use, featuring a responsive touchpad and long-lasting battery.',
    price: 799.99,
    ratings: 4.0,
    images: [
      {
  ...
  },
  {
    ...
    description: 'The latest gaming console with cutting-edge graphics and a vast library of games.',
    price: 499.99,
    ratings: 4.5,
    images: [
      {
  ...
  {
    name: 'Canon EOS R5',
    description: 'A professional-grade mirrorless camera with outstanding image quality and 8K video recording.',
    price: 3499.99,
    ratings: 4.75,
    images: [
      {
  ...
  },
  {
    ...
    description: 'A stunning 4K OLED TV with vibrant colors, perfect for a cinematic viewing experience.',
    price: 1499.99,
    ratings: 4.5,
    images: [
      {
  ...
  },
  {
    ...
    description: 'High-performance running shoes with responsive cushioning and a breathable design.',
    price: 129.99,
    ratings: 4.25,
    images: [
      {
  ...
  {
    name: 'Apple iPad Air',
    description: 'A lightweight and powerful tablet with a stunning Retina display.',
    price: 649.99,
    ratings: 4.5,
    images: [
      {
